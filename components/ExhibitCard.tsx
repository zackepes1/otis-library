...
const ShoeCard = ({imgURL, changeExhibitImage, exhibitImg }) => {
  const handleClick = () => {
    ...
    return (
    <div className={`border-2 mt-5 rounded-xl
    ${exhibitImg === imgURL.exhibitImage ? 'border-blue-500' : 'border-transparent'} cursor-pointer`}
    onClick={handleClick}>
